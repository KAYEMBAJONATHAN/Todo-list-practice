...
"use strict";
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://todo-practice/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://todo-practice/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://todo-practice/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://todo-practice/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _module_todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/todolist.js */ \"./src/module/todolist.js\");\n/* harmony import */ var _module_todolist_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_module_todolist_js__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nconst list = document.querySelector('.tasks-list');\nconst addTodo = document.querySelector('.form');\nconst descript = document.querySelector('#title');\nconst remoTasks = document.querySelector('.removeAll');\n\nconst todoList = new (_module_todolist_js__WEBPACK_IMPORTED_MODULE_1___default())();\n\nremoTasks.addEventListener('click', () => {\n  todoList.cleanCompleted();\n  todoList.setStorage();\n  todoList.displayToDo(list);\n});\naddTodo.addEventListener('submit', (e) => {\n  e.preventDefault();\n  if (descript.value.trim()) {\n    todoList.addTask(descript.value);\n    todoList.setStorage();\n    todoList.resetIndex();\n    todoList.displayToDo(list);\n    addTodo.reset();\n  }\n});\n\ndocument.addEventListener('click', (e) => {\n  if (e.target && e.target.classList.contains('delete')) {\n    const id = parseInt(e.target.parentElement.id, 10);\n    todoList.removeList(id);\n    todoList.resetIndex();\n    todoList.setStorage();\n    todoList.displayToDo(list);\n  }\n});\n\ndocument.addEventListener('DOMContentLoaded', () => {\n  todoList.getStorage();\n  todoList.displayToDo(list);\n});\n\n//# sourceURL=webpack://todo-practice/./src/index.js?");
